...
class EnvConfigService {
    ...
    getConfig(key) {
        var _a;
        if ((_a = this.config) === null || _a === void 0 ? void 0 : _a.hasOwnProperty(key)) {
            return this.config[key];
        }
        return null;
    }
}
EnvConfigService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: EnvConfigService, deps: [{ token: ENV_CONFIG }], target: i0.ɵɵFactoryTarget.Injectable });
EnvConfigService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: EnvConfigService, providedIn: 'root' });
...
class AppConfigService {
    ...
    setPatientVisitSections(data) {
        var _a;
        data.patient_visit_sections = ((_a = data === null || data === void 0 ? void 0 : data.patient_visit_sections) !== null && _a !== void 0 ? _a : [])
            .map((pvs) => {
            return Object.assign(Object.assign({}, pvs), { lang: pvs.lang ? (typeof pvs.lang === 'object' ? pvs.lang : JSON.parse(pvs.lang)) : null });
        });
    }
    get tourConfig() {
        try {
...
AppConfigService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: AppConfigService, deps: [{ token: i1.HttpClient }, { token: EnvConfigService }], target: i0.ɵɵFactoryTarget.Injectable });
...
function getFieldValueByLanguage(element) {
    ...
    if ((_b = (_a = element === null || element === void 0 ? void 0 : element.lang) === null || _a === void 0 ? void 0 : _a[selectedLanguage]) === null || _b === void 0 ? void 0 : _b.trim()) {
        return element.lang[selectedLanguage].trim();
    }
    // Return the first non-empty language value
    for (const langValue of Object.values((element === null || element === void 0 ? void 0 : element.lang) || {})) {
        if (langValue.trim()) {
...
function calculateBMI(vitals, vitalObs, _locale = 'en') {
    var _a, _b, _c, _d;
    const heightUUID = (_a = vitals === null || vitals === void 0 ? void 0 : vitals.find((v) => v.key === 'height_cm')) === null || _a === void 0 ? void 0 : _a.uuid;
    const weightUUID = (_b = vitals === null || vitals === void 0 ? void 0 : vitals.find((v) => v.key === 'weight_kg')) === null || _b === void 0 ? void 0 : _b.uuid;
    let height = null, weight = null;
    if (heightUUID && weightUUID) {
        height = (_c = vitalObs.find((e) => e.concept.uuid === heightUUID)) === null || _c === void 0 ? void 0 : _c.value;
        weight = (_d = vitalObs.find((e) => e.concept.uuid === weightUUID)) === null || _d === void 0 ? void 0 : _d.value;
    }
    if (height && weight) {
 ...
 */
function convertCelsiusToFahrenheit(celsius, _locale = 'en') {
...
function getAge(birthdate, translateService, short = false) {
    if (!birthdate)
        return '';
    const now = moment();
...
function obsParse(obs, uuid = "") {
    try {
        if (uuid)
            return Object.assign({ uuid: uuid }, JSON.parse(obs));
        else
            return Object.assign({}, JSON.parse(obs));
    }
    catch (error) {
        return { uuid: uuid };
    }
...
class VisitService {
    ...
    */
    getData(data) {
        if (data === null || data === void 0 ? void 0 : data.value.toString().startsWith("{")) {
    ...
    */
    getData2(data) {
        if (data === null || data === void 0 ? void 0 : data.value_text.toString().startsWith("{")) {
    ...
    */
    ...
    formatMedicineDisplay(medicine, uuid) {
        ...
        const splitMed = (_a = medicine === null || medicine === void 0 ? void 0 : medicine.split) === null || _a === void 0 ? void 0 : _a.call(medicine, ':');
        let med = {
            drug: (_b = splitMed === null || splitMed === void 0 ? void 0 : splitMed[0]) !== null && _b !== void 0 ? _b : '-',
            dose: (_c = splitMed === null || splitMed === void 0 ? void 0 : splitMed[1]) !== null && _c !== void 0 ? _c : '-',
            durationNo: (_d = splitMed === null || splitMed === void 0 ? void 0 : splitMed[2]) !== null && _d !== void 0 ? _d : '-',
            durationUnit: (_e = splitMed === null || splitMed === void 0 ? void 0 : splitMed[3]) !== null && _e !== void 0 ? _e : '-',
            instructRemark: (_f = splitMed === null || splitMed === void 0 ? void 0 : splitMed[4]) !== null && _f !== void 0 ? _f : '-',
            frequency: (_g = splitMed === null || splitMed === void 0 ? void 0 : splitMed[5]) !== null && _g !== void 0 ? _g : '-'
        };
        if (uuid)
            med.uuid = uuid;
        return med;
...
DiagnosisService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: DiagnosisService, deps: [{ token: i1.HttpClient }, { token: i2.MatSnackBar }], target: i0.ɵɵFactoryTarget.Injectable });
DiagnosisService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: DiagnosisService, providedIn: 'root' });
...
class LibPresciptionComponent {
    constructor(data, dialogRef, appConfigService, translateService, visitService, diagnosisService, profileService, envService) {
        ...
        this.envService = envService;
        this.isDownloadPrescription = false;
        this.pvsConfigs = [];
        this.pvsConstant = VISIT_SECTIONS;
        this.patientRegFields = [];
        this.completedEncounter = null;
        this.spokenWithPatient = 'No';
        this.notes = [];
        this.medicines = [];
        ...
        this.dignosisSecondary = {};
        this.referralSecondary = "";
        this.conceptDiagnosis = '537bb20d-d09d-4f88-930b-cc45c7d662df';
        this.conceptNote = '162169AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA';
        this.conceptMed = 'c38c0c50-2fd2-4ae3-b7ba-7dd25adca4ca';
        this.conceptAdvice = '67a050c1-35e5-451c-a4ab-fff9d57b0db1';
        this.conceptTest = '23601d71-50e6-483f-968d-aeef3031346d';
        this.conceptReferral = '605b6f15-8f7a-4c45-b06d-14165f6974be';
        this.conceptFollow = 'e8caffd6-5d22-41c4-8d6a-bc31a44d0c86';
        this.conceptFollowUpInstruction = conceptIds.conceptFollowUpInstruction;
        this.conceptDiscussionSummary = 'b673cd54-a01d-4d8a-9c07-8fb19bf4982c';
        this.signaturePicUrl = null;
        this.signatureFile = null;
        this.cheifComplaints = [];
        this.vitalObs = [];
        this.vitals = [];
        this.hasVitalsEnabled = false;
        this.hasPatientOtherEnabled = false;
        this.hasPatientAddressEnabled = false;
    ...
    ngOnInit() {
        ...
        this.appConfigService.load().then(() => {
            ...
            this.hasPatientAddressEnabled = ((_a = this.appConfigService) === null || _a === void 0 ? void 0 : _a.patient_reg_address) || false;
            this.hasPatientOtherEnabled = ((_b = this.appConfigService) === null || _b === void 0 ? void 0 : _b.patient_reg_other) || false;
            Object.keys(this.appConfigService.patient_registration).forEach(obj => {
                this.patientRegFields.push(...this.appConfigService.patient_registration[obj]
                    .filter((e) => e.is_enabled)
                    .map((e) => e.name));
            });
            this.logoImageURL = (_c = this.appConfigService.theme_config.find(obj => obj.key === 'logo')) === null || _c === void 0 ? void 0 : _c.value;
            this.pvsConfigs = (_d = this.appConfigService.patient_visit_sections) === null || _d === void 0 ? void 0 : _d.filter((pvs) => [
        ...
        this.eventsSubscription = (_a = this.download) === null || _a === void 0 ? void 0 : _a.subscribe((val) => {
            if (val) {
                            ...
                            if (encounter.encounterType.display === visitTypes.VISIT_COMPLETE) {
                                ...
                                encounter.encounterProviders.forEach((p) => {
                                    ...
                                    if (this.isDownloadPrescription) {
                                        this.setSignature((_a = this.signature) === null || _a === void 0 ? void 0 : _a.value, (_b = this.signatureType) === null || _b === void 0 ? void 0 : _b.value);
                                    }
                                });
                            }
                        });
            ...
            if (enc.encounterType.display === visitTypes.ADULTINITIAL) {
                enc.obs.forEach((obs) => {
                    ...
                    if (obs.concept.display === visitTypes.CURRENT_COMPLAINT) {
                        const currentComplaint = (_a = this.visitService.getData(obs)) === null || _a === void 0 ? void 0 : _a.value.split('<b>');
                                ...
                                if (splitByBr[0].includes(visitTypes.ASSOCIATED_SYMPTOMS)) {
                                    ...
                                    for (let k = 1; k < splitByBr.length; k++) {
                                        if (splitByBr[k].trim() && splitByBr[k].trim().length > 1) {
                                            ...
                                            const processedStrings = splitByDash === null || splitByDash === void 0 ? void 0 : splitByDash.slice(1, splitByDash.length).join('-').split(".").map(itemList => {
                ...
                if (obs.encounter.visit.uuid === this.visit.uuid) {
                    if (this.isFeatureAvailable('dp_diagnosis_secondary')) {
                        ...
                        if (obs.value.includes("::")) {
                            obsValues = (_a = obs.value.split("::").pop()) === null || _a === void 0 ? void 0 : _a.split(":");
                        }
                        const obsValuesOne = (_b = obsValues === null || obsValues === void 0 ? void 0 : obsValues[1]) === null || _b === void 0 ? void 0 : _b.split('&');
                        this.existingDiagnosis.push({
                            diagnosisName: (_d = (_c = obsValues === null || obsValues === void 0 ? void 0 : obsValues[0]) === null || _c === void 0 ? void 0 : _c.trim()) !== null && _d !== void 0 ? _d : '',
                            diagnosisType: (_f = (_e = obsValuesOne === null || obsValuesOne === void 0 ? void 0 : obsValuesOne[0]) === null || _e === void 0 ? void 0 : _e.trim()) !== null && _f !== void 0 ? _f : '',
                            diagnosisStatus: (_h = (_g = obsValuesOne === null || obsValuesOne === void 0 ? void 0 : obsValuesOne[1]) === null || _g === void 0 ? void 0 : _g.trim()) !== null && _h !== void 0 ? _h : '',
                            uuid: obs.uuid,
                        });
                    }
                }
  ...
  */
    ...
    */
    checkIfMedicationPresent() {
        this.medicines = [];
        this.standardMedicines = [];
        this.diagnosisService.getObs(this.baseUrl, this.visit.patient.uuid, conceptIds.conceptMed).subscribe((response) => {
            response.results.forEach((obs) => {
                var _a, _b, _c, _d, _e, _f, _g, _h;
                if (obs.encounter.visit.uuid === this.visit.uuid) {
                    if (obs.value.includes(':')) {
                        if ((_a = this.appConfigService.patient_visit_summary) === null || _a === void 0 ? void 0 : _a.standard_medication) {
                            this.standardMedicines.push(this.visitService.formatMedicineDisplay(obs.value, obs.uuid));
                        }
                        else {
                            this.medicines.push({
                                drug: (_b = obs.value) === null || _b === void 0 ? void 0 : _b.split(':')[0],
                                strength: (_c = obs.value) === null || _c === void 0 ? void 0 : _c.split(':')[1],
                                days: (_d = obs.value) === null || _d === void 0 ? void 0 : _d.split(':')[2],
                                timing: (_e = obs.value) === null || _e === void 0 ? void 0 : _e.split(':')[3],
                                remark: (_f = obs.value) === null || _f === void 0 ? void 0 : _f.split(':')[4],
                                frequency: ((_g = obs.value) === null || _g === void 0 ? void 0 : _g.split(':')[5]) ? (_h = obs.value) === null || _h === void 0 ? void 0 : _h.split(':')[5] : "",
                                uuid: obs.uuid
                            });
                        }
                    }
    ...
    */
    checkIfAdditionalInstructionPresent() {
        ...
        this.diagnosisService.getObs(this.baseUrl, this.visit.patient.uuid, this.conceptMed)
            ...
            response.results.forEach((obs) => {
                var _a;
                const obsValue = typeof obs.value === 'string' ? obs.value : (((_a = obs.value) === null || _a === void 0 ? void 0 : _a.display) || String(obs.value || ''));
   ...
   */
            ...
            response.results.forEach((obs) => {
                ...
                if (obs.encounter.visit.uuid === this.visit.uuid) {
                    ...
                    if (obs.value.includes('Time:') || obs.value.includes('Remark:')) {
                        ...
                        const time = (_c = (_b = (_a = result.find((v) => v.includes('Time:'))) === null || _a === void 0 ? void 0 : _a.split('Time:')) === null || _b === void 0 ? void 0 : _b[1]) === null || _c === void 0 ? void 0 : _c.trim();
                        const remark = (_f = (_e = (_d = result.find((v) => v.includes('Remark:'))) === null || _d === void 0 ? void 0 : _d.split('Remark:')) === null || _e === void 0 ? void 0 : _e[1]) === null || _f === void 0 ? void 0 : _f.trim();
                        const type = (_j = (_h = (_g = result.find((v) => v.includes('Type:'))) === null || _g === void 0 ? void 0 : _g.split('Type:')) === null || _h === void 0 ? void 0 : _h[1]) === null || _j === void 0 ? void 0 : _j.trim();
    ...
    */
     ...
     * @returns {void}
     */
    getAbhaDetails(_patient) {
        var _a, _b;
        this.patient.person.abhaNumber = (_a = _patient.identifiers.find((v) => { var _a, _b; return ((_b = (_a = v.identifierType) === null || _a === void 0 ? void 0 : _a.display) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'abha number'; })) === null || _a === void 0 ? void 0 : _a.identifier;
        this.patient.person.abhaAddress = (_b = _patient.identifiers.find((v) => { var _a, _b; return ((_b = (_a = v.identifierType) === null || _a === void 0 ? void 0 : _a.display) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'abha address'; })) === null || _b === void 0 ? void 0 : _b.identifier;
    }
    /**
    * Check visit status
    * @param {EncounterModel[]} encounters - Array of encounters
    ...
    */
    get attributes() {
        var _a;
        return Array.isArray((_a = this.consultedDoctor) === null || _a === void 0 ? void 0 : _a.attributes) ? this.consultedDoctor.attributes : [];
    }
    /**
    ...
    */
    get signatureType() {
        return this.attributes.find((a) => { var _a; return ((_a = a === null || a === void 0 ? void 0 : a.attributeType) === null || _a === void 0 ? void 0 : _a.display) === doctorDetails.SIGNATURE_TYPE; });
    }
    /**
    ...
    */
    get signature() {
        return this.attributes.find((a) => { var _a; return ((_a = a === null || a === void 0 ? void 0 : a.attributeType) === null || _a === void 0 ? void 0 : _a.display) === doctorDetails.SIGNATURE; });
    }
    /**
            ...
            case 'diagnosis':
                if (this.isFeatureAvailable('dp_diagnosis_secondary')) {
                    ...
                    this.existingDiagnosis.forEach((d) => {
                        var _a, _b, _c;
                        const row = [(_a = d.diagnosisName) !== null && _a !== void 0 ? _a : '', (_b = d.diagnosisType) !== null && _b !== void 0 ? _b : '', (_c = d.diagnosisStatus) !== null && _c !== void 0 ? _c : ''];
                        records.push(row);
                    });
                }
                else {
            ...
            case 'followUp':
                if (this.followUp) {
                    const followUpRow = [
                        ...
                        (this.isFeatureAvailable('followUpType') ? [(_a = this.followUp.followUpType) !== null && _a !== void 0 ? _a : '-'] : []),
                        this.followUp.followUpDate ? moment(this.followUp.followUpDate).format('DD MMM YYYY') : '-',
                        (this.isFeatureAvailable('followUpTime') ? (_b = this.followUp.followUpTime) !== null && _b !== void 0 ? _b : '-' : ''),
                        (_c = this.followUp.followUpReason) !== null && _c !== void 0 ? _c : '-'
                    ];
    ...
    */
    getObsValue(uuid, key) {
        ...
        let value = (v === null || v === void 0 ? void 0 : v.value) ? (typeof v.value == 'object') ? (_a = v.value) === null || _a === void 0 ? void 0 : _a.display : v.value : null;
        if (!value && key === 'bmi') {
    ...
    get shouldShowProfilePhoto() {
        var _a, _b;
        return this.checkPatientRegField('Profile Photo') && Boolean((_b = (_a = this.patient) === null || _a === void 0 ? void 0 : _a.person) === null || _b === void 0 ? void 0 : _b.uuid);
    }
    getPersonalInfo() {
        const data = {
            colSpan: 4,
        ...
        this.appConfigService.patient_registration['personal'].forEach((e) => {
            ...
            switch (e.name) {
                case 'Gender':
                    value = ((_a = this.patient) === null || _a === void 0 ? void 0 : _a.person.gender) == 'M' ? 'Male' : 'Female';
                    break;
                case 'Age':
                    value = this.getAge((_b = this.patient) === null || _b === void 0 ? void 0 : _b.person.birthdate);
                    break;
                case 'Date of Birth':
                    value = new Date((_c = this.patient) === null || _c === void 0 ? void 0 : _c.person.birthdate).toDateString();
                    break;
                case 'Phone Number':
            ...
            if (e.name === 'Phone Number') {
                if (((_d = this.appConfigService) === null || _d === void 0 ? void 0 : _d.abha_section) && ((_f = (_e = this.patient) === null || _e === void 0 ? void 0 : _e.person) === null || _f === void 0 ? void 0 : _f.abhaNumber)) {
                    other.push({
                        stack: [
                ...
                if (((_g = this.appConfigService) === null || _g === void 0 ? void 0 : _g.abha_section) && ((_j = (_h = this.patient) === null || _h === void 0 ? void 0 : _h.person) === null || _j === void 0 ? void 0 : _j.abhaAddress)) {
                    other.push({
                        stack: [
        ...
        for (let i = 0; i < other.length; i += chunkSize) {
            const chunk = other === null || other === void 0 ? void 0 : other.slice(i, i + chunkSize);
            ...
            this.appConfigService.patient_registration['address'].forEach((e) => {
                ...
                switch (e.name) {
                    case 'Household Number':
                        value = (_c = (_b = (_a = this.patient) === null || _a === void 0 ? void 0 : _a.person) === null || _b === void 0 ? void 0 : _b.preferredAddress) === null || _c === void 0 ? void 0 : _c.address6;
                        break;
                    case 'Corresponding Address 1':
                        value = (_f = (_e = (_d = this.patient) === null || _d === void 0 ? void 0 : _d.person) === null || _e === void 0 ? void 0 : _e.preferredAddress) === null || _f === void 0 ? void 0 : _f.address1;
                        break;
                    case 'Corresponding Address 2':
                        value = (_j = (_h = (_g = this.patient) === null || _g === void 0 ? void 0 : _g.person) === null || _h === void 0 ? void 0 : _h.preferredAddress) === null || _j === void 0 ? void 0 : _j.address2;
                        break;
                    case 'Block':
                        value = (_m = (_l = (_k = this.patient) === null || _k === void 0 ? void 0 : _k.person) === null || _l === void 0 ? void 0 : _l.preferredAddress) === null || _m === void 0 ? void 0 : _m.address3;
                        break;
                    case 'Village/Town/City':
                        value = (_p = (_o = this.patient) === null || _o === void 0 ? void 0 : _o.person.preferredAddress) === null || _p === void 0 ? void 0 : _p.cityVillage;
                        break;
                    case 'District':
                        value = (_r = (_q = this.patient) === null || _q === void 0 ? void 0 : _q.person.preferredAddress) === null || _r === void 0 ? void 0 : _r.countyDistrict;
                        break;
                    case 'State':
                        value = (_t = (_s = this.patient) === null || _s === void 0 ? void 0 : _s.person.preferredAddress) === null || _t === void 0 ? void 0 : _t.stateProvince;
                        break;
                    case 'Country':
                        value = (_v = (_u = this.patient) === null || _u === void 0 ? void 0 : _u.person.preferredAddress) === null || _v === void 0 ? void 0 : _v.country;
                        break;
                    case 'Postal Code':
                        value = (_x = (_w = this.patient) === null || _w === void 0 ? void 0 : _w.person.preferredAddress) === null || _x === void 0 ? void 0 : _x.postalCode;
                        break;
                    default:
                        break;
                }
    ...
    */
    ...
    getDoctorRecommandation() {
        ...
        if ((_a = this.appConfigService) === null || _a === void 0 ? void 0 : _a.patient_visit_summary.standard_medication) {
                            ...
                            [
                                {
                                    ...
                                    table: {
                                        ...
                                        body: [
                                            medicinesHeaders,
                                            ...this.getRecords((((_b = this.appConfigService) === null || _b === void 0 ? void 0 : _b.patient_visit_summary.standard_medication) ? 'standardMedication' : 'medication'))
                                        ]
                                    },
   ...
   */
    downloadPrescription() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const docDefinition = yield this.generatePdf(); // Get the PDF content
    ...
    generatePdf() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userImg = yield this.toObjectUrl(`${this.baseUrl}/personimage/${(_a = this.patient) === null || _a === void 0 ? void 0 : _a.person.uuid}`);
                const logo = yield this.toObjectUrl(`${this.configPublicURL}${this.logoImageURL}`);
                ...
                let logoImage = { text: '' };
                if (logo && !(logo === null || logo === void 0 ? void 0 : logo.includes('application/json')) && !(logo === null || logo === void 0 ? void 0 : logo.includes('text/html'))) {
                ...
                if (signatureValue.includes("amazonaws.com")) {
                    signatureValue = yield this.toObjectUrl(`${this.signature.value}`);
                }
                const pdfObj = {
                    pageSize: 'A4',
                                    ...
                                    [
                                        {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    [
                                                        {
                                                            image: (userImg && !(userImg === null || userImg === void 0 ? void 0 : userImg.includes('application/json'))) && this.checkPatientRegField('Profile Photo') ? userImg : 'user',
                                                            width: 30,
                                                            height: 30,
                                                            margin: [0, (userImg && !(userImg === null || userImg === void 0 ? void 0 : userImg.includes('application/json'))) ? 15 : 5, 0, 5]
                                                        },
                                                        [
                                                            {
                                                                text: `${(_e = (_d = (_c = (_b = this.patient) === null || _b === void 0 ? void 0 : _b.person) === null || _c === void 0 ? void 0 : _c.preferredName) === null || _d === void 0 ? void 0 : _d.givenName) === null || _e === void 0 ? void 0 : _e.toUpperCase()}` + (this.checkPatientRegField('Middle Name') && ((_h = (_g = (_f = this.patient) === null || _f === void 0 ? void 0 : _f.person) === null || _g === void 0 ? void 0 : _g.preferredName) === null || _h === void 0 ? void 0 : _h.middleName) ? ' ' + ((_m = (_l = (_k = (_j = this.patient) === null || _j === void 0 ? void 0 : _j.person) === null || _k === void 0 ? void 0 : _k.preferredName) === null || _l === void 0 ? void 0 : _l.middleName) === null || _m === void 0 ? void 0 : _m.toUpperCase()) : '') + ` ${(_r = (_q = (_p = (_o = this.patient) === null || _o === void 0 ? void 0 : _o.person) === null || _p === void 0 ? void 0 : _p.preferredName) === null || _q === void 0 ? void 0 : _q.familyName) === null || _r === void 0 ? void 0 : _r.toUpperCase()}`,
                                                                bold: true,
                                                                margin: [10, 10, 0, 5],
                                                            }
                                                        ]
                                                    ...
                                                    [
                                                        {
                                                            colSpan: 2,
                                                            ul: [
                                                                { text: [{ text: 'Patient ID:', bold: true }, ` ${this.getPersonAttributeValue('TMH Case Number') !== 'NA' ? this.getPersonAttributeValue('TMH Case Number') : (_u = (_t = (_s = this.patient) === null || _s === void 0 ? void 0 : _s.identifiers) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.identifier}`], margin: [0, 5, 0, 5] },
                                                                { text: [{ text: 'Date of Consultation:', bold: true }, ` ${moment((_v = this.completedEncounter) === null || _v === void 0 ? void 0 : _v.encounterDatetime).format('DD MMM yyyy')}`], margin: [0, 5, 0, 5] }
                                                            ]
                                                        }
                                                    ]
                                                ]
                                    ...
                                    [
                                        {
                                            ...
                                            stack: [
                                                ...
                                                { text: `Dr. ${(_w = this.consultedDoctor) === null || _w === void 0 ? void 0 : _w.name}`, margin: [0, 0, 0, 0] },
                                                { text: `${(_x = this.consultedDoctor) === null || _x === void 0 ? void 0 : _x.typeOfProfession}` },
                                                { text: `Registration No. ${(_y = this.consultedDoctor) === null || _y === void 0 ? void 0 : _y.registrationNumber}` },
                                            ]
                                        },
                                        '',
                                        '',
                    ...
                    images: Object.assign(Object.assign({}, precription), logo),
                    styles: {
                        header: {
                            fontSize: 14,
                            bold: true,
                ...
                pdfObj.content[0].table.body = pdfObj.content[0].table.body.filter((section, index) => {
                    ...
                    if (section[0].sectionName === 'vitals' && (!this.hasVitalsEnabled || !(vitalsConfig === null || vitalsConfig === void 0 ? void 0 : vitalsConfig.is_enabled))) {
                        console.log('Filtering out vitals section');
                        return false;
                    }
                    if (section[0].sectionName === 'cheifComplaint' && !(checkUpReasonConfig === null || checkUpReasonConfig === void 0 ? void 0 : checkUpReasonConfig.is_enabled)) {
                    ...
                    if (section[0].sectionName === 'specialtyNotes' && !((_a = this.specialtyNotes) === null || _a === void 0 ? void 0 : _a.length)) {
                        return false;
                    }
                    return true;
                });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: LibPresciptionComponent, decorators: [{
        ...
        return [{ type: undefined, decorators: [{
                    ...
                    }] }, { type: i1$1.MatDialogRef }, { type: AppConfigService }, { type: i3.TranslateService }, { type: VisitService }, { type: DiagnosisService }, { type: ProfileService }, { type: EnvConfigService }];
    }, propDecorators: { isDownloadPrescription: [{
                type: Input
            }], visitId: [{
                type: Input
            }], download: [{
...
LibPresciptionService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: LibPresciptionService, deps: [{ token: i1.HttpClient }, { token: i1$1.MatDialog }, { token: 'environment' }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: LibPresciptionService, decorators: [{
        ...
        return [{ type: i1.HttpClient }, { type: i1$1.MatDialog }, { type: undefined, decorators: [{
                        type: Inject,
                        args: ['environment']
                    }] }];
    } });
